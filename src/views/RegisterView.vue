...
<template>
  <div class="flex items-start justify-center h-screen">
    <div class="card w-full bg-base-100 m-4">
      ...
      <form method="post" class="card-body items-center text-center gap-y-4 pt-4">
        ...
        <label class="input input-bordered flex items-center gap-2">
          ...
          <input type="text" class="grow" placeholder="Apellido" />
        </label>
        ...
        <label class="input input-bordered flex items-center gap-2">
          ...
          <input ref="input" type="password" class="grow" placeholder="Confirmar contraseña" />
        </label>
